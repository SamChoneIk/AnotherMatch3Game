...
public class Piece : MonoBehaviour
{
    ...
    private FindMatches findMatches; // 블럭이 매치되었는지 확인
    private Board board; // 현재 게임의 블럭들을 저장
    public GameObject otherPiece; // 위치를 바꾼 블럭
    ...
    public bool isColumnBomb; // 세로줄에 해당하는 아이템
    public bool isRowBomb; // 가로줄에 해당하는 아이템
    public GameObject columnArrow; // 아이템 
    public GameObject rowArrow; // 아이템
